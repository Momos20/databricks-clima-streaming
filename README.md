...
### Error: cambio de esquema

Si cambió la estructura del JSON o de las tablas, ejecutar el pipeline con:
...
### Error: rutas diferentes

Validar que la ruta de salida del notebook fuente y la ruta de lectura de Bronze sean iguales:
...
- Credenciales.
- Tokens.
- Información privada del workspace.
- Capturas internas obligatorias.
- Datos sensibles.

La carpeta `assets/screenshots/` puede usarse para agregar capturas propias del dashboard si se desea complementar la entrega.

---

## 15. Conclusión

Este proyecto demuestra la construcción de un flujo de datos en Databricks con arquitectura Lakehouse para procesar información climática en tiempo casi real.

El resultado permite consumir datos desde una API pública, almacenarlos como archivos JSON, procesarlos mediante Bronze, Silver y Gold, construir métricas analíticas y visualizar los resultados en un dashboard interactivo.
